function lvl2_multiT(params,type,TRafterEV,numShuffels)
...
outFolder=fullfile(params.dataDir,['MultiGroupRes/pc_TR1_peakTR' num2str(TRafterEV) '_' type '_31N_20.06.2021']);
