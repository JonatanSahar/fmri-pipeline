...
params.multiout_dir=fullfile(params.dataDir,num2str(subject) ,'/derive',['multiTmaps_pc_TR' num2str(TRafterEV) '_noEV']);
addpath('../multit/code/helper_functions');
%addpath('neuroelf');
addpath('../../niiTool');
% dataDir=params.dataDir;
%% load mask
maskfn = fullfile(params.dataDir,'group_standard_mask.nii.gz');
